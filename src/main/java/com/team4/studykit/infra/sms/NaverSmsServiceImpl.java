...
import com.team4.studykit.infra.sms.dto.NaverSmsMessageDTO;
import com.team4.studykit.infra.sms.dto.NaverSmsRequestDTO;
import com.team4.studykit.infra.sms.dto.NaverSmsResponseDTO;
...
public class NaverSmsServiceImpl implements NaverSmsService {
    ...
    @Value("${naver.access_key}")
    private String accessKey;
    @Value("${naver.secret_key}")
    private String secretKey;
    @Value("${naver.sms_id}")
    private String serviceId;
    @Value("${naver.sms_phone_number}")
